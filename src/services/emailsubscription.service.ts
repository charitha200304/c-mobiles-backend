import Subscription, { IEmailSubscription } from '../models/emailsubscription.model';
...
class SubscriptionService {
     ...
     */
    public async subscribeEmail(email: string): Promise<IEmailSubscription> {
        try {
     ...
     */
    public async findSubscriptionByEmail(email: string): Promise<IEmailSubscription | null> {
        try {
